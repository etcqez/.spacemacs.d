...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;;; 报错
  (setq ispell-extra-args '("--lang=en_US")) ;; Aspell 根据你的 Locale 选择语言和对应的词典，想要在中文环境（zh_CN）下检测英文，你需要明确地告诉 Aspell，通过命令行选项或者配置文件，Aspell 的文档里有解释，要是用命令行选项的话，可以把它丢到 ispell 的 ispell-extra-args 中去，估计像这样：
